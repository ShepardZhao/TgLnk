...
/** GET user **/
    .get('/user/info', function (req, res, next) {
    ...
    /* GET user check. */
    .get('/user/userIDCheck', function (req, res, next) {
...
//user email check
    ...
    .get('/user/userEmailCheck', function (req, res, next) {
...
//user information update
    .put('/user/info', function (req, res, next) {
...
//user avatar upload
    .post('/user/avatar', function (req, res, next) {
