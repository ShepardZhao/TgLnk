...
- (void)imagePickerViewSetup {
    ...
    UIFont *btnFont = [UIFont systemFontOfSize:14.0];
    ...
    for (UIButton *btn in @[self.photoLibraryBtn, self.cameraBtn, self.cancelBtn]) {
        [btn setTitleColor:RGB2UICOLOR(189,195,199,1.0)forState:UIControlStateNormal];
    }
...
- (void)navigationController:(UINavigationController *)navigationController willShowViewController:(UIViewController *)viewController animated:(BOOL)animated {
    [SystemUIViewControllerModel
     hideBottomHairline:viewController.navigationController.navigationBar];
